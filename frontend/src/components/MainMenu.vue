...
let items = ref([
  ...
  { title: 'Llista de Menús', link: '/menuweeklist', selected: false, loggedIn: true },
  { title: 'Edita Ingredients', link: '/editingredients', selected: false, loggedIn: true },
  { title: 'Edita Receptes', link: '/editrecipes', selected: false, loggedIn: true },
